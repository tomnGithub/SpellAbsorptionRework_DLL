...
namespace RE
{
	TESFile* TESFile::Duplicate(std::uint32_t a_cacheSize)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::Duplicate) };
	...
	std::uint32_t TESFile::GetCurrentSubRecordType()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::GetCurrentSubRecordType) };
		return func(this);
	}
	...
	FormType TESFile::GetFormType()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::GetFormType) };
		return func(this);
	}
	...
	void TESFile::ReadData(void* a_buf, std::uint32_t a_size)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::ReadData) };
	...
	bool TESFile::Seek(std::uint32_t a_offset)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::Seek) };
	...
	bool TESFile::SeekNextSubrecord()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(TESFile::SeekNextSubrecord) };
		return func(this);
	}
}
