...
namespace RE
{
	...
	void BSResourceNiBinaryStream::seek(std::int32_t a_numBytes)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(BSResourceNiBinaryStream::Seek) };
	...
	void BSResourceNiBinaryStream::set_endian_swap(bool a_doSwap)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(BSResourceNiBinaryStream::SetEndianSwap) };
	...
	BSResourceNiBinaryStream* BSResourceNiBinaryStream::ctor(const char* a_name, bool a_writeable, BSResource::Location* a_optionalStart)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(BSResourceNiBinaryStream::Ctor) };
	...
	void BSResourceNiBinaryStream::dtor()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(BSResourceNiBinaryStream::Dtor) };
		return func(this);
	}
}
