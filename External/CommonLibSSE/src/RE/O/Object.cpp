...
namespace RE
{
	namespace BSScript
	{
		...
		VMHandle Object::GetHandle() const
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(BSScript::Object::GetHandle) };
			return func(this);
		}
		...
		void Object::IncRef()
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(BSScript::Object::IncRef) };
			return func(this);
		}
		...
		std::uint32_t Object::DecRef()
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(BSScript::Object::DecRef) };
			return func(this);
		}
		...
		void Object::Dtor()
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(BSScript::Object::Dtor) };
			return func(this);
		}
	}
}
