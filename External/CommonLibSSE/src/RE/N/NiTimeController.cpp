...
namespace RE
{
	...
	void NiTimeController::LoadBinary(NiStream& a_stream)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::LoadBinary) };
	...
	void NiTimeController::LinkObject(NiStream& a_stream)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::LinkObject) };
		return func(this, a_stream);
	}
	...
	bool NiTimeController::RegisterStreamables(NiStream& a_stream)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::RegisterStreamables) };
		return func(this, a_stream);
	}
	...
	void NiTimeController::SaveBinary(NiStream& a_stream)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::SaveBinary) };
		return func(this, a_stream);
	}
	...
	bool NiTimeController::IsEqual(NiObject* a_object)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::IsEqual) };
	...
	void NiTimeController::ProcessClone(NiCloningProcess& a_cloning)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::ProcessClone) };
	...
	void NiTimeController::Start(float a_time)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::Start) };
	...
	void NiTimeController::Stop()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::Stop) };
		return func(this);
	}
	...
	void NiTimeController::SetTarget(NiObjectNET* a_target)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::SetTarget) };
	...
	float NiTimeController::ComputeScaledTime(float a_time)
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::ComputeScaledTime) };
		return func(this, a_time);
	}
	...
	NiTimeController* NiTimeController::ctor()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::Ctor) };
		return func(this);
	}
	...
	void NiTimeController::dtor()
	{
		...
		REL::Relocation<func_t> func{ STATIC_OFFSET(NiTimeController::Dtor) };
		return func(this);
	}
}
