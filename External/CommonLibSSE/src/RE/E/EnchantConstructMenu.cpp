...
namespace RE
{
	namespace CraftingSubMenus
	{
		...
		void EnchantConstructMenu::RenameItem_Impl(InventoryEntryData* a_entryData, ExtraDataList* a_extraList, const char* a_name)
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(CraftingSubMenus::EnchantConstructMenu::RenameItem) };
		...
		void EnchantConstructMenu::UpdateInterface()
		{
			...
			REL::Relocation<func_t> func{ STATIC_OFFSET(CraftingSubMenus::EnchantConstructMenu::UpdateInterface) };
			return func(this);
		}
	}
}
